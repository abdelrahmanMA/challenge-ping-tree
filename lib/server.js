...
router.set('/api/targets', {
  POST: endpoints.addNewTarget,
  GET: endpoints.getAllTargets
})
router.set('/api/target/:id', {
  POST: endpoints.updateTargetById,
  GET: endpoints.getTargetById
})
router.set('/route', { POST: endpoints.getDecision })
